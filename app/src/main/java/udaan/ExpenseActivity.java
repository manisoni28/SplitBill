...
public class ExpenseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expense = (Expense)myIntent.getSerializableExtra("updProd");
        ...
        for (String name : nameLst.keySet()) {
            ...
            seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                    ...
                    if (i==0 && checkbox2.isChecked()) i = 10;
                    if (i==100) i = 90;
    ...
    private void populateUpd(Expense p, HashMap<String,LinearLayout> nameLst) {
        ...
        for (String name : nameLst.keySet()) {
            ...
            seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                    i = Math.round(i/step ) * step;
                    if (i==0 && finalCheckbox.isChecked()) i = 10;
                    if (i==100) i = 90;
                    seekBar.setProgress(i);
                }
    ...
    private boolean newProduct (HashMap<String,LinearLayout> nameLst) {
        ...
        if (!upd) {
            if (prodNames.contains(productName.getText().toString())) {
                Toast.makeText(getApplicationContext(), "Expense already specified.", Toast.LENGTH_LONG).show();
                return false;
            }
        }
        ...
        if (
            ...
            expense = new Expense(productName.getText().toString(),
        ...
        switch (item.getItemId()) {
            case R.id.action_new:
                if (newProduct(nameLst)) {
                    ...
                    returnIntent.putExtra("result", expense);
